...
def bash(chaintomove, inputdir, outputdir):
    ...
    arg = ['/netapp/home/james.lucas/Rosetta/main/source/bin/rosetta_scripts.linuxgccrelease',
           ...
           pdb_relpath,
           '-parser:protocol',
           '../../../DDGBenchmarks_Test/RosettaScripts/DDG_Protocol_v1_dfpmin.xml',
...
#Define paths
outputdir = 'DDG_Zemu_v2_output_dfpmin/'
...
error_out = 'SubmitRun_DDG_Zemu_General_v2_dfpmin.py.e' + str(job_id) + '.' + str(sge_task_id)
output_out = 'SubmitRun_DDG_Zemu_General_v2_dfpmin.py.o' + str(job_id) + '.' + str(sge_task_id)
