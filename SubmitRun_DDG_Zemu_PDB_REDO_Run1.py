...
####asdf = open("~/ddg-zemu-runs/160315-kyleb_james-backrub-rscript/data/blank_job_dict.json")
    asdf = open("/netapp/home/james.lucas/Zemu-PDB_REDO_Dataset/data/blank_job_dict.json")
...
def neighbors_list(pdb_filepath, pdb_file):
    neighbors = find_neighbors("/netapp/home/james.lucas/Zemu-PDB_REDO_Dataset/"+pdb_filepath, "/netapp/home/james.lucas/Zemu-PDB_REDO_Dataset/"+pdb_file, 8)
    pivotlist = ''
    for i in neighbors:
...
def resfile_stuff(pdb_filepath):
    resfile = read_mutations_resfile("/netapp/home/james.lucas/Zemu-PDB_REDO_Dataset/"+pdb_filepath)
    for i in resfile:
        position = i[0]
        chain = i[1]
        mut_to = i[3]
...
def bash(chaintomove, pdb_file):
    #Working Directory
    workingdir = '/netapp/home/james.lucas/DDG_Zemu_PDB_REDO_Run1_Output/'
...
#Cluster Usage - Minimization
    arg = ['/netapp/home/james.lucas/rosetta_src_2016.08.58479_bundle/main/source/bin/rosetta_scripts.linuxgccrelease',
           '-s',
           '/netapp/home/james.lucas/Zemu-PDB_REDO_Dataset/%s/%s.pdb' %(data_dir, PDBID),
           '-parser:protocol',
