...
if __name__ == '__main__':
    ...
    rosetta_scripts_command_line = cfg.rosetta_scripts_command_line
    rosetta_scripts_file = cfg.rosetta_scripts_file
    rosetta_scripts_score_fxn = cfg.rosetta_scripts_score_fxn
    ...
    if not existing_job:
        ...
        ppi_api.add_development_protocol_command_lines(
            prediction_set_id, protocol_name, 'rosetta_scripts', rosetta_scripts_command_line, os.path.abspath(rosetta_scripts_file)
        )
        # 2x because bugs
        # ppi_api.add_development_protocol_command_lines(
    ...
    for prediction_id in prediction_ids:
        ...
        argdict = {
            ...
            '-parser:protocol' : 'data/alanine_scanning.xml',
        }
